...
public class ProdutoDAOTest {
    ...
    public void testCreate() throws Exception {
        ...
        Produto obj = new Produto("Caneta preta", unidade, 23.00);
    ...
    public void testUpdate() throws Exception {
        ...
        Unidade unidade = UnidadeDAO.create(new Unidade("Metros", "mt"));
        Produto obj1 = new Produto(1, "Canetão Azul", unidade, 23.00);
        ProdutoDAO.update(obj1);
        Produto obj2 = new Produto(1, "Quadro Negro", unidade, 23.00);
    ...
    public void testDelete() throws Exception {
        ...
        Unidade unidade = UnidadeDAO.create(new Unidade("Metros", "mt"));
        Produto obj = new Produto("Placa de trânsito", unidade, 23.00);
