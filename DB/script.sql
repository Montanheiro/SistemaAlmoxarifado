...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `almoxarifado`.`estoque` ;
...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`itens_empenho` (
  ...
  PRIMARY KEY (`id`, `empenho`, `natureza_despesa`),
...
-- -----------------------------------------------------
-- Table `almoxarifado`.`itensempenho_entradas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `almoxarifado`.`itensempenho_entradas` ;

CREATE TABLE IF NOT EXISTS `almoxarifado`.`itensempenho_entradas` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `itens_empenho` INT NOT NULL,
  `entradas` INT NOT NULL,
  PRIMARY KEY (`id`, `itens_empenho`, `entradas`),
...
-- -----------------------------------------------------
-- Table `almoxarifado`.`estoque_bruto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `almoxarifado`.`estoque_bruto` ;

CREATE TABLE IF NOT EXISTS `almoxarifado`.`estoque_bruto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `produto` INT NOT NULL,
  `quantidade` DOUBLE NOT NULL,
