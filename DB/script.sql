...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`entradas` (
  ...
  `nf_numero` VARCHAR(255) NOT NULL,
  `considerar_valorsequencia` TINYINT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `almoxarifado`.`produtosempenho_entradas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almoxarifado`.`produtosempenho_entradas` (
  `produtos_empenho` INT NOT NULL,
  `entradas` INT NOT NULL,
  PRIMARY KEY (`produtos_empenho`, `entradas`),
  INDEX `fk_produtos_empenho_has_entradas_entradas1_idx` (`entradas` ASC),
  INDEX `fk_produtos_empenho_has_entradas_produtos_empenho1_idx` (`produtos_empenho` ASC),
  CONSTRAINT `fk_produtos_empenho_has_entradas_produtos_empenho1`
    FOREIGN KEY (`produtos_empenho`)
...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`entradas_doacaotransferencia` (
  ...
  PRIMARY KEY (`entradas`, `doacao_ou_transferencia`),
  INDEX `fk_entradas_has_doacao_ou_transferencia_doacao_ou_transfere_idx` (`doacao_ou_transferencia` ASC),
  INDEX `fk_entradas_has_doacao_ou_transferencia_entradas1_idx` (`entradas` ASC),
