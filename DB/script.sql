...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`produtos` (
  ...
  `estoque` DOUBLE NULL DEFAULT 0.00,
  `estoque_minimo` DOUBLE NULL DEFAULT 0.00,
  `valor_total` DOUBLE NULL DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`produtos_fornecedores` (
  ...
  `fornecedor` INT NOT NULL,
  `produto` INT NOT NULL,
  PRIMARY KEY (`id`, `fornecedor`, `produto`),
  INDEX `fk_fornecedores_has_produtos_produtos1_idx` (`produto` ASC),
  INDEX `fk_fornecedores_has_produtos_fornecedores1_idx` (`fornecedor` ASC),
...
CREATE TABLE IF NOT EXISTS `almoxarifado`.`doacoes_ou_transferencias` (
  ...
  PRIMARY KEY (`id`, `tipo`, `entrada`),
  INDEX `fk_doacoes_ou_transferencias_table11_idx` (`tipo` ASC),
  INDEX `fk_doacoes_ou_transferencias_entradas1_idx` (`entrada` ASC),
  CONSTRAINT `fk_doacoes_ou_transferencias_table11`
    FOREIGN KEY (`tipo`)
    REFERENCES `almoxarifado`.`tipos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_doacoes_ou_transferencias_entradas1`
    FOREIGN KEY (`entrada`)
    REFERENCES `almoxarifado`.`entradas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `almoxarifado`.`empenhos_entradas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `almoxarifado`.`empenhos_entradas` ;

CREATE TABLE IF NOT EXISTS `almoxarifado`.`empenhos_entradas` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `entrada` INT NOT NULL,
  `empenho` INT NOT NULL,
  PRIMARY KEY (`id`, `entrada`, `empenho`),
  INDEX `fk_empenhos_has_entradas_entradas1_idx` (`entrada` ASC),
  CONSTRAINT `fk_empenhos_has_entradas_empenhos1`
    FOREIGN KEY (`empenho`)
    REFERENCES `almoxarifado`.`empenhos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empenhos_has_entradas_entradas1`
    FOREIGN KEY (`entrada`)
    REFERENCES `almoxarifado`.`entradas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
